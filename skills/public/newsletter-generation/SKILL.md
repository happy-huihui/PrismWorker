...
> **IMPORTANT**: Always check `<current_datetime>` to ensure search queries use the correct temporal context. Never use hardcoded years.
...
- Always use `<current_datetime>` for temporal context in searches and date references in the newsletter
