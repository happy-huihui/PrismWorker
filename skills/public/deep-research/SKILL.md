...
# Use temporal qualifiers — always use the ACTUAL current year from <current_datetime>
...
**Always check `<current_datetime>` in your context before forming ANY search query.**

`<current_datetime>` gives you the full date: year, month, day, and weekday (e.g. `2026-02-28, Saturday`). Use the right level of precision depending on what the user is asking:
